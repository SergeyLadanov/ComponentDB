var elementTypes = ["Все", "Конденсатор", "Резистор", "Катушка индуктивности", "Транзистор", "Микросхема", "Модуль", "Разъем", "Варистор", "Диод", "Светодиод", "Стабилитрон", "Переключатель", "Кварцевый резонатор", "Трансформатор", "Фотоэлемент", "Тиристор"];
