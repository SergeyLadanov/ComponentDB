...
Выгрузка всей спецификации и списка на дозаказ содержит четыре столбца: `#`,
`Тип элемента`, `Наименование` и `Количество`. Наименование собирается через
пробел из всех заполненных параметров позиции, артикула и производителя. В полной
спецификации указывается требуемое количество, в дозаказе — недостающее.
